...
while(true) {
    ...
    switch(option) {
        ...
        case '1':
            ...
            const insertAge: number = Number(ask('Insert your age: '));
        ...
        case '5':
            ...
            if (residentNumber < 0 || residentNumber >= arrayResident.length) {
                logger('Invalid resident.');
                break;
             }
        ...
        case '6':
            ...
            if (residentNum < 0 || residentNum >= residentsInRoom.length) {
                logger('Invalid resident number.');
                break;
            }
