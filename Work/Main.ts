...
const drakar: Warrior = new Warrior('Drakar', 15, 155, 35, ak47, ak47);
const boran: Warrior = new Warrior('Boran', 25, 185, 45, glock, glock);

const alister: Mage = new Mage('Alister', 5, 110, 55, bolaFogo, bolaFogo);
const aestra: Mage = new Mage('Aestra', 10, 130, 45, misseisMagicos, misseisMagicos);

const members: Party = new Party('Party Causing Damage', [drakar, boran, alister, aestra]);

const globin: Monster = new Monster('Globin', 30, 155, 40);
